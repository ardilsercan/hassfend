...
export namespace FAIterators {
	 ...
	 */
	function ensureDeterministicOut<S, O>(iter: FAIterator<S, O>): FAIterator<S, O>;
	/**
	 ...
	 * @param iter
	 */
	function iterateWordSets<S>(iter: FAIterator<S, Iterable<[S, CharSet]>>): Iterable<CharSet[]>;
}
/**
