...
function* findDuplicationNfa(alternatives, { hasNothingAfter, parser, ignoreOverlap }) {
    const previous = [];
    for (let i = 0; i < alternatives.length; i++) {
        const alternative = alternatives[i];
...
exports.default = utils_1.createRule("no-dupe-disjunctions", {
    ...
    create(context) {
        ...
        let reportExponentialBacktracking = "potential";
        if ((_a = context.options[0]) === null || _a === void 0 ? void 0 : _a.reportExponentialBacktracking) {
            reportExponentialBacktracking =
                (_b = context.options[0]) === null || _b === void 0 ? void 0 : _b.reportExponentialBacktracking;
        }
        else {
            if (((_c = context.options[0]) === null || _c === void 0 ? void 0 : _c.alwaysReportExponentialBacktracking) ===
                false) {
                reportExponentialBacktracking =
                    "none";
            }
        }
        const reportUnreachable = (_e = (_d = context.options[0]) === null || _d === void 0 ? void 0 : _d.reportUnreachable) !== null && _e !== void 0 ? _e : "certain";
        const report = (_g = (_f = context.options[0]) === null || _f === void 0 ? void 0 : _f.report) !== null && _g !== void 0 ? _g : "trivial";
