...
exports.default = utils_1.createRule("prefer-quantifier", {
    ...
    create(context) {
        ...
        function createVisitor({ node, fixerApplyEscape, getRegexpRange, }) {
            return {
                onAlternativeEnter(aNode) {
                    ...
                    function validateBuffer(buffer) {
                        ...
                        const lastRange = getRegexpRange(buffer.elements[buffer.elements.length - 1]);
                        let range = null;
                        ...
                        context.report({
                            ...
                            fix(fixer) {
                                ...
                                return fixer.replaceTextRange(range, fixerApplyEscape(buffer.target.raw) +
